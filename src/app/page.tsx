      ...
      <div className="flex md:flex-row md:flex-start flex-col-reverse items-start md:items-center w-full justify-between mb-12 mt-20">
        <div className="flex flex-col">
          <Link
            ...
            className="w-fit focus:ring-4 rounded-full focus:ring-offset-2 dark:ring-offset-black border-none my-2 ring-primary duration-300 outline-none font-semibold"
          >
            <div className="flex items-center p-1 text-sm px-3 w-fit rounded-full text-white bg-primary">
